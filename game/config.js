...
export const CONFIG = {
    gridSize: 40, 
    visibleTrackKeys: ['circuit', 'alloyRing', 'mistwoodSerpent', 'carbonBend', 'sunlitTemple', 'moebiusStrip', 'blueSector', 'harborParkLoop', 'jadeSpiralCircuit', 'cedarRidgeCircuit', 'sakuraWeave', 'royalPlateau', 'twinRise'],
