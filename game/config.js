...
export const CONFIG = {
    gridSize: 40, 
    visibleTrackKeys: ['circuit', 'sunlitTemple', 'moebiusStrip', 'blueSector', 'harborParkLoop', 'jadeSpiralCircuit', 'cedarRidgeCircuit', 'sakuraWeave', 'royalPlateau', 'twinRise', 'kettleRun'],
